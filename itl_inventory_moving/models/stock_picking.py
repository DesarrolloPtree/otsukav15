...
class Picking(models.Model):
    ...
    itl_delivery_date = fields.Datetime('Actual Delivery Date', store=True, states={'done': [('readonly', True)], 'cancel': [('readonly', True)]})
    ...
    def button_validate(self):
        ...
        if self.picking_type_code in ['internal'] and self.itl_warehouse_id != self.itl_warehouse_dest_id:
