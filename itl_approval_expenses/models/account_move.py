...
class AccountMove(models.Model):
    ...
    itl_force_post = fields.Boolean(string="Force post", compute="_compute_force_post")

    def _get_payment(self):
        self.payment_id = False
        if self.advance_sheet_id:
            if self.advance_sheet_id.itl_payment_ids:
    ...
    @api.depends('date')
    def _compute_force_post(self):
        for move in self:
            move.itl_force_post = False
